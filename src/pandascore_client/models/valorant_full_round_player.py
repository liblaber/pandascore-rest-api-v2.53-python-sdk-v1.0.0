...
class ValorantFullRoundPlayer(BaseModel):
    ...
    def __init__(
        ...
        self.combat_score = self._define_number("combat_score", combat_score, ge=0)
        self.eco_beg_prep = self._define_number("eco_beg_prep", eco_beg_prep, ge=0)
        self.eco_end_prep = self._define_number("eco_end_prep", eco_end_prep, ge=0)
