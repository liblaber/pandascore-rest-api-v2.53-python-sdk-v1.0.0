...
class LoLGameTeam(BaseModel):
    ...
    def __init__(
        ...
        self.cloud_drake_kills = self._define_number(
            "cloud_drake_kills", cloud_drake_kills, nullable=True, ge=0
        )
        ...
        self.herald_kills = self._define_number(
            "herald_kills", herald_kills, nullable=True, ge=0
        )
