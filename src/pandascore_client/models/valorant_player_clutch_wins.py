...
class ValorantPlayerClutchWins(BaseModel):
    ...
    def __init__(
        ...
        :type versus_5: int
        """
        self.versus_1 = self._define_number("versus_1", versus_1, nullable=True, ge=0)
        self.versus_2 = self._define_number("versus_2", versus_2, nullable=True, ge=0)
        self.versus_3 = self._define_number("versus_3", versus_3, nullable=True, ge=0)
        self.versus_4 = self._define_number("versus_4", versus_4, nullable=True, ge=0)
        self.versus_5 = self._define_number("versus_5", versus_5, nullable=True, ge=0)
